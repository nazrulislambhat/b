...
<div";
  ...
  ";
        ...
        $this->env->getExtension('\Drupal\Core\Template\TwigExtension')
            ->checkDeprecations($context, ["attributes", "title_prefix", "label", "title_attributes", "title_suffix", "recommended", "featured", "past"]);        return; yield '';
    }
    ...
    public function block_content($context, array $blocks = [])
    {
      ...
      <div class=\"slider-container\">
        <div class=\"tabs\">
         <button class=\"tab-button active\">Recommended Conferences</button>
          <button class=\"tab-button\">Featured Conferences</button>
          <button class=\"tab-button\">Past Conferences</button>
        </div>
        <div class=\"conference-slider recommended-conferences active\">
          ";
        // line 48
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["recommended"] ?? null), 48, $this->source), "html", null, true);
        yield "
        </div>
        <div class=\"conference-slider featured-conferences\">
          ";
        // line 51
        yield $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(($context["featured"] ?? null), 51, $this->source), "html", null, true);
        yield "
        </div>
